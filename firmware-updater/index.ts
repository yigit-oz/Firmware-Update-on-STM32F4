...
const PACKET_RETX_DATA0     = 0x11;
const PACKET_ACK_DATA0      = 0x1F;

const BL_PACKET_SYNC_OBSERVED_DATA0     = 0x17;
const BL_PACKET_FW_UPDATE_REQ_DATA0     = 0x25;
const BL_PACKET_FW_UPDATE_RES_DATA0     = 0x28;
const BL_PACKET_DEVICE_ID_REQ_DATA0     = 0x30;
const BL_PACKET_DEVICE_ID_RES_DATA0     = 0x3F;
const BL_PACKET_FW_LENGTH_REQ_DATA0     = 0x43;
const BL_PACKET_FW_LENGTH_RES_DATA0     = 0x4F;
const BL_PACKET_READY_FOR_DATA_DATA0    = 0x53;
const BL_PACKET_UPDATE_SUCCESSFUL_DATA0 = 0x63;
const BL_PACKET_NACK_DATA0              = 0x69;

const BOOTLOADER_SIZE = 0x8000;

const DEVICE_ID = 0x49;
const SYNC_SEQ = Buffer.from([0xC4, 0xA9, 0x6F, 0x4B]);
